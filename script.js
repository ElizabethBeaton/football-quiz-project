      function nameFootballer1() {
        ...
        let team = prompt(
          "What club team does this footballer currently play for?"
        );
      ...
      function nameFootballer2() {
        ...
        name = name
          .toLowerCase()
          .trim()
          .replace("cristiano ronaldo", "ronaldo");
        if (name === "ronaldo") {
        ...
        let clubTeam = prompt(
          "What club team did Ronaldo play for in 2021/2022?"
        );
        clubTeam = clubTeam
          .toLowerCase()
          .trim()
        ...
        if (clubTeam === "manchester united") {
          ...
          alert(
            "Not quite! In 2021 Ronaldo returned to Manchester United🔴⚽️!"
          )
        }

        let italianClub = prompt(
          "What Italian club team has Ronaldo played for?"
        );
      ...
      function nameFootballer3() {
        ...
        if (position === "attacker") {
          ...
          alert(
            "Though he is a great defender, Neymar is known as an attacker!🤩"
          )
        }
      }
      ...
      function nameFootballer5() {
        ...
        if (name === "mbappe") {
          alert(
            "Yessss it is!😁 One of the greatest footballers in the world!🤩 "
          );
        } else {
        ...
        let amount = prompt(
          "How many goals did Mbappe score in the World Cup 2022?"
        );
        amount = amount.trim();
        if (amount === "8") {
          alert(
      ...
      function nameFootballer7() {
        ...
        if (penalties === "2") {
          ...
          alert(
            "Nope 👎🏼. England had two penalties in their quarter final game."
          )
        }
      ...
      function nameFootballer9() {
        ...
        let year = prompt(
          "What year did Benzema win his first Ballon D'Or award?"
        );
        year = year.trim();
        if (year === "2022") {
          alert(
